...
export const FAQItems: FAQItem[] = [{
    ...
    content: (
        <p>
            Public sale starts on July 16th 7pm UTC. Early access sale starts on July 15th 8pm UTC.
        </p>
    )
}, {
    id: 'potluck-labs',
